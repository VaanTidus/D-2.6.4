package com.ankamagames.berilia.components
{
    ...
    public class Slot extends ButtonContainer implements ISlotDataHolder, FinalizableUIComponent, IDragAndDropHandler
    {
        ...
        override public function process(param1:Message) : Boolean
        {
            ...
            var _loc_8:uint = 0;
            var _loc_9:IDragAndDropHandler = null;
            var _loc_10:SlotDragAndDropData = null;
            var _loc_11:ISlotDataHolder = null;
            var _loc_12:IInterfaceListener = null;
            var _loc_13:IInterfaceListener = null;
            if (this._isButton)
            {
                _loc_3 = 9999;
