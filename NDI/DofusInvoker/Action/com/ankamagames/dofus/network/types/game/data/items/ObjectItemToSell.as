package com.ankamagames.dofus.network.types.game.data.items
{
    ...
    public class ObjectItemToSell extends Item implements INetworkType
    {
        ...
        public function initObjectItemToSell(param1:uint = 0, param2:int = 0, param3:Boolean = false, param4:Vector.<ObjectEffect> = null, param5:uint = 0, param6:uint = 0, param7:uint = 0) : ObjectItemToSell
        {
