package flashx.textLayout.elements
{
    ...
    public class ListElement extends ContainerFormattedElement
    {
        ...
        private static const romanDigitFunction:Vector.<Function> = ListElement.Vector.<Function>([@%@function ()@%@29895@%@, @%@function ()@%@29896@%@, @%@function ()@%@29897@%@, @%@function ()@%@29898@%@, @%@function ()@%@29899@%@, @%@function ()@%@29900@%@, @%@function ()@%@29901@%@, @%@function ()@%@29902@%@, @%@function ()@%@29903@%@, @%@function ()@%@29904@%@]);
        ...
        function computeListItemText(param1:ListItemElement, param2:IListMarkerFormat) : String
        {
            ...
            var _loc_8:ListElement = null;
            var _loc_9:IListMarkerFormat = null;
